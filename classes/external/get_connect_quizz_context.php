...
/**
 * Trait implementing the external function block_assignmentsquizzes_report
 */
trait get_connect_quizz_context
{
    /**
    ...
    public static  function get_connect_quizz_context_parameters()
    {
     ...
     * Return context.
     */
    public static function get_connect_quizz_context($username)
    {
        global $USER, $PAGE;
        ...
        self::validate_parameters(self::get_connect_quizz_context_parameters(), array('username' => $username));
     ...
     */
    public static function get_connect_quizz_context_returns()
    {
        return new external_single_structure(array(
            'html' =>  new external_value(PARAM_RAW, 'HTML with the Connect quizz table context'),
        ));
    }
}
